        ...
        <div className="contact-section">
          ...
          <div className="section-center">
            <div className="container">
              <div className="row justify-content-center">
                <div className="col-12 text-center">
                  <a href="#" className="hover-target">ramirumi@naver.com</a>
                </div>
            ...
            <div className="row justify-content-center">
              ...
              <div className="col-12 text-center">
                <p className="familynet">
                  <font className = "travel hover-target" id="promotion">Promotion</font> / <font className = "travel hover-target" id="dmBanner">Direct Mailing</font>
                </p>
              </div>
              ...
              {/* 프로모션 배너 */}
                ...
                {/* life */}
                <div className="col-md-6 col-lg-10 promotion">
                  <img src="/images/promotion/1911_muhan.jpg" alt="" />
                </div>
                <div className="col-md-6 col-lg-10 promotion">
